...
monaco.editor.defineTheme('ccframe-tools-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('ccframe-tools-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'ccframe-tools-dark' : 'ccframe-tools-light'),
  { immediate: true },
);
