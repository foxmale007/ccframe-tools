...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/CorentinTh/ccframe-tools',
      category: 'External',
      description: 'View the source code of ccframe-tools on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve ccframe-tools.',
      href: 'https://github.com/CorentinTh/ccframe-tools/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about ccframe-tools.',
      to: '/about',
      category: 'Pages',
